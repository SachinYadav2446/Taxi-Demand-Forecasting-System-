  ...
  return (
    <div className="min-h-screen bg-[#020202] text-white flex font-poppins selection:bg-orange-500/30 overflow-hidden relative">
      ...
      >
        ...
        <div className="flex items-center px-6 py-8 shrink-0 border-b border-white/[0.03]">
          <Link to="/" className="flex items-center gap-4 group">
            <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center shadow-[0_0_20px_rgba(249,115,22,0.3)] group-hover:shadow-[0_0_30px_rgba(249,115,22,0.5)] transition-all duration-500">
            ...
            return (
              <Link
                ...
                className={`relative flex items-center gap-4 px-4 py-3.5 rounded-2xl transition-all duration-300 group overflow-hidden ${
                  active ? 'text-white' : 'text-slate-500 hover:text-white hover:bg-white/[0.02]'
                }`}
              >
                {active && (
                  <motion.div
      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 z-40 px-5 py-4 border-b border-white/[0.05] flex justify-between items-center backdrop-blur-3xl bg-black/80">
        ...
        <button onClick={logout} className="p-2 rounded-xl bg-red-500/10 text-red-500">
          <LogOut size={16} />
        </button>
      </header>
