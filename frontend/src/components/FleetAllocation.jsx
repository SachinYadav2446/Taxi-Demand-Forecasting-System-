...
export default function FleetAllocation({ fleetSize, hotspots }) {
  ...
  return (
    <div className="rounded-3xl border border-orange-500/20 bg-gradient-to-b from-orange-900/10 to-[#0a0a0a] p-6 mt-6 relative overflow-hidden">
      ...
      <div className="space-y-3 relative z-10">
        {allocationLayout.map((alloc, i) => (
          <div key={alloc.location_id} className="group relative flex items-center justify-between rounded-2xl bg-[#0f0f0f] border border-[#222] p-4 hover:border-orange-500/40 transition-colors">
